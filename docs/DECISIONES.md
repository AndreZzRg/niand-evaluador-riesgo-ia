# Registro de decisiones de arquitectura — Evaluador de Riesgo de IA
...
**Contexto.** GitHub Pages sirve el proyecto bajo `/niand-evaluador-riesgo-ia/`. Fijar esa ruta en la
