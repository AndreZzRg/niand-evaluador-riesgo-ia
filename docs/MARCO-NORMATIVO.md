# Marco normativo — Evaluador de Riesgo de IA
...
|---|---|---|
| **Ley 1581 de 2012** | Tratamiento de datos personales en entrenamiento e inferencia; autorización para analítica y perfilamiento. | 17 sep 2026 |
| **Ley 1480 de 2011** | Estatuto del Consumidor: información veraz y suficiente. | 17 sep 2026 |
| **NIST AI RMF 1.0** | Marco de referencia voluntario: Govern, Map, Measure, Manage. | 17 sep 2026 |
| **ISO/IEC 42001:2023** | Sistema de gestión de inteligencia artificial. | 17 sep 2026 |
