# Arquitectura — Evaluador de Riesgo de IA
...
Una carpeta por módulo: `ficha-del-sistema`, `evaluacion-nist-ai-rmf`, `matriz-de-riesgo`, `controles-iso-42001`, `plan-de-tratamiento`.
...
`localStorage` bajo claves con prefijo `niand-evaluador-riesgo-ia:`.
