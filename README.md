...
# 🤖 Evaluador de Riesgo de IA

**Evaluación de riesgo de sistemas de inteligencia artificial**

Laboratorio 09 de la suite de cumplimiento operable de **NiAnd Labs S.A.S.**

[![CI](https://github.com/AndreZzRg/niand-evaluador-riesgo-ia/actions/workflows/ci.yml/badge.svg)](https://github.com/AndreZzRg/niand-evaluador-riesgo-ia/actions/workflows/ci.yml)
[![Pages](https://github.com/AndreZzRg/niand-evaluador-riesgo-ia/actions/workflows/pages.yml/badge.svg)](https://github.com/AndreZzRg/niand-evaluador-riesgo-ia/actions/workflows/pages.yml)
[![CodeQL](https://github.com/AndreZzRg/niand-evaluador-riesgo-ia/actions/workflows/codeql.yml/badge.svg)](https://github.com/AndreZzRg/niand-evaluador-riesgo-ia/actions/workflows/codeql.yml)
...
### [▶ Abrir la aplicación](https://andrezzrg.github.io/niand-evaluador-riesgo-ia/)
...
Evaluación estructurada del riesgo de un sistema de inteligencia artificial sobre las funciones del NIST AI RMF 1.0 y los controles de la ISO/IEC 42001, cruzada con las obligaciones colombianas realmente exigibles en materia de datos personales, decisiones automatizadas y protección al consumidor.

> [!NOTE]
> Colombia no tiene una ley de inteligencia artificial vigente. Los proyectos PL 043 y 324 de 2025 y PL 042 de 2025 estaban en trámite a septiembre de 2026. Esta herramienta no afirma obligatoriedad donde no la hay.

### Módulos

1. **Ficha del sistema**
2. **Evaluación NIST AI RMF**
3. **Matriz de riesgo**
4. **Controles ISO 42001**
...
```bash
git clone https://github.com/AndreZzRg/niand-evaluador-riesgo-ia.git
cd niand-evaluador-riesgo-ia
npm install
npm run dev
```
...
```bash
# Con GitHub CLI
gh repo create AndreZzRg/niand-evaluador-riesgo-ia --public --source=. --remote=origin --push

# O de forma manual, si ya creó el repositorio vacío en github.com
git remote add origin https://github.com/AndreZzRg/niand-evaluador-riesgo-ia.git
git branch -M main
...
```
https://andrezzrg.github.io/niand-evaluador-riesgo-ia/
```
...
| **Ley 1581 de 2012** | Tratamiento de datos personales en entrenamiento e inferencia; autorización para analítica y perfilamiento. |
| **Ley 1480 de 2011** | Estatuto del Consumidor: información veraz y suficiente. |
| **NIST AI RMF 1.0** | Marco de referencia voluntario: Govern, Map, Measure, Manage. |
