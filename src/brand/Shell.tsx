...
export const MODULOS = [
  { id: 'ficha-del-sistema', rotulo: 'Ficha del sistema' },
  { id: 'evaluacion-nist-ai-rmf', rotulo: 'Evaluación NIST AI RMF' },
  { id: 'matriz-de-riesgo', rotulo: 'Matriz de riesgo' },
  { id: 'controles-iso-42001', rotulo: 'Controles ISO 42001' },
  { id: 'plan-de-tratamiento', rotulo: 'Plan de tratamiento' },
] as const;
    ...
    <div className="flex min-h-dvh flex-col">
      ...
      <header className="no-imprimir sticky top-0 z-30 border-b border-borde bg-superficie/92 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-x-4 gap-y-2 px-4 py-3 sm:px-6">
          <a
            href="https://github.com/AndreZzRg/niand-evaluador-riesgo-ia"
            className="shrink-0"
            aria-label="Repositorio de Evaluador de Riesgo de IA"
          >
            <Logo alto={28} />
          </a>
          ...
          <div className="min-w-0 flex-1">
            <p className="truncate font-display text-sm font-semibold">
              <span aria-hidden>🤖 </span>Evaluador de Riesgo de IA
            </p>
